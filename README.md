# Скрипт для поиска ответов на платформе Socrative

Этот Python-скрипт предназначен для автоматического получения правильных ответов на вопросы типа True/False, одиночного выбора и множественного выбора на платформе Socrative, используя два метода:

1. **Метод утечки количества правильных ответов**: Позволяет просматривать количество правильных ответов до завершения теста, даже без доступа.
2. **Метод изменения вариантов ответов**: Позволяет изменять варианты ответа, даже при отсутствии прав доступа.
